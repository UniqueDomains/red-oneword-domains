# Available .RED One-Word Domains (18,430)
...
**Public extract:** 1,000 rows · **Live catalog:** 18,430 domains · **Median ask:** $24.00 · **High-demand under $2,500:** 0
...
| ------------ | --------- | --------- | ------------- | -------------- | ------ | ------ | -------------------------- |
| style.red    | premium   | $750      | —             | high           | low    | 5      | name.com                   |
...
> Unique Domains. *Available .RED One-Word Domains*. Version 2026-09-03. Public GitHub extract for the exact Unique Domains search represented by this repository.
